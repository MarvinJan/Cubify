(function() {
  class Cubify {
    ...
    rotateCube(event, x, y) {
      const deltaX = this.calculateDelta(x, event.clientX);
      const deltaY = this.calculateDelta(y, event.clientY);
    ...
    calculateDelta(initial, current) {
    ...
    removeListener(element, listener, callback) {
